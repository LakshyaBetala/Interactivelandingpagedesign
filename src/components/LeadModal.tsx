        ...
        <>
          ...
          <div className="fixed inset-0 z-[101] flex items-center justify-center p-6 pointer-events-none">
            <motion.div
              ...
              className="bg-[#E6DFD5] w-full max-w-lg max-h-[85vh] overflow-y-auto shadow-2xl p-8 lg:p-12 border border-[#C4B8A8]/30 pointer-events-auto"
            >
              ...
              >
                <span className="flex flex-col">
                  <span className="font-sans font-semibold">Book a 15-min call</span>
